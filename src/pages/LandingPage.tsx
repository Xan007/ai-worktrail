...
export function LandingPage() {
  ...
  return (
    <main className="page-fade bg-[#FAFBFC] min-h-screen flex flex-col justify-between">
        ...
        <section className="relative overflow-hidden border-b border-[#E2E8F0] bg-white px-6 py-12 lg:py-20">
          <div className="mx-auto grid max-w-[1140px] items-center gap-12 lg:grid-cols-12">
            ...
            <div className="space-y-6 lg:col-span-7">
              {/* Título principal */}
              <h1 className="text-3xl font-bold tracking-tight text-[#0F172A] sm:text-4xl lg:text-5xl leading-[1.15]">
                Evalúa cómo piensan con la IA, no solo qué entregan.
              </h1>

              {/* Subtítulo */}
              <p className="text-base text-[#334155] sm:text-lg leading-relaxed">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <Link
                  to="/onboarding"
                  className="inline-flex items-center gap-2 rounded-md bg-[#0077CC] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#0066B3] shadow-xs"
                >
                  Comenzar ahora
                  <ArrowRight size={16} />
                </Link>
                <a
                  href="#como-funciona"
                  className="inline-flex items-center gap-2 rounded-md border border-[#E2E8F0] bg-white px-5 py-3 text-sm font-semibold text-[#0F172A] transition-colors hover:border-[#0077CC] hover:text-[#0077CC]"
                >
                  Ver cómo funciona
                </a>
              </div>
            ...
            <div className="lg:col-span-5">
              <div className="overflow-hidden rounded-xl border border-[#E2E8F0] bg-white shadow-md transition-shadow hover:shadow-lg">
                {/* Header simulado de app */}
                <div className="flex items-center justify-between border-b border-[#E2E8F0] bg-[#F8FAFD] px-4 py-3">
                  <div className="flex items-center gap-2">
                    <UserCheck size={16} className="text-[#0077CC]" />
                    <span className="text-xs font-bold tracking-tight text-[#0F172A]">Entregas Recientes · Evaluación IA</span>
                  </div>
                  <span className="rounded bg-[#E0F2FE] px-2 py-0.5 font-mono text-[10px] font-semibold text-[#0077CC]">
                    VISTA PREVIA
                  </span>
                </div>
                ...
                <div className="p-4 space-y-3">
                  {MOCK_HERO_SUBMISSIONS.map((sub) => (
                    <div
                      key={sub.name}
                      className="flex flex-col gap-2 rounded-lg border border-[#EEF1F6] bg-[#FAFBFC] p-3.5 transition-colors hover:bg-white hover:border-[#E2E8F0]"
                    >
                ...
                <div className="border-t border-[#EEF1F6] bg-[#F8FAFD] px-4 py-2.5 text-center">
                  <span className="text-[11px] text-[#64748B]">Análisis automático de chats de Gemini, ChatGPT y Claude</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="como-funciona" className="bg-white px-6 py-16 lg:py-20 border-b border-[#E2E8F0]">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {STEPS.map((step) => {
              ...
              return (
                <div
                  key={step.num}
                  className="flex flex-col justify-between rounded-xl border border-[#E2E8F0] bg-[#FAFBFC] p-6 transition-colors hover:border-[#0077CC]/40 hover:bg-white hover:shadow-xs"
                >
                  <div>
                    <div className="mb-4 flex items-center justify-between">
                      ...
                      <span className="font-mono text-xl font-extrabold text-[#0077CC]/30">
                        {step.num}
                      </span>
                    </div>
      ...
      <section className="px-6 py-16 lg:py-20 bg-[#FAFBFC] border-b border-[#E2E8F0]">
        <div className="mx-auto max-w-[1040px]">
          ...
          <div className="overflow-hidden rounded-xl border border-[#E2E8F0] bg-white p-6 shadow-xs space-y-5">
            {CRITERIA.map((c) => (
              <div key={c.criterion} className="space-y-2 border-b border-[#EEF1F6] pb-4 last:border-b-0 last:pb-0">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                  <div>
                    <h3 className="text-sm font-semibold text-[#0F172A]">{c.criterion}</h3>
                    <p className="text-xs text-[#64748B]">{c.description}</p>
                  </div>
                  <span className="font-mono text-xs font-bold text-[#0077CC] shrink-0 self-start sm:self-auto">
                    {c.weight}
                  </span>
                </div>
                ...
                <div className="h-2.5 w-full overflow-hidden rounded-full bg-[#F0F3F8]">
                  <div
                    className="h-full bg-[#0077CC] transition-[width] duration-300"
      ...
      <section className="bg-white px-6 py-16 lg:py-20 border-b border-[#E2E8F0]">
        <div className="mx-auto max-w-[1040px]">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {/* Docentes */}
            <div className="rounded-xl border border-[#E2E8F0] bg-[#FAFBFC] p-7 transition-colors hover:bg-white hover:shadow-xs">
              <div className="mb-4 flex size-12 items-center justify-center rounded-xl bg-[#E0F2FE] text-[#0077CC]">
      ...
      <section className="bg-[#FAFBFC] px-6 py-16">
        <div className="mx-auto max-w-[900px] text-center">
          <div className="rounded-2xl border border-[#0077CC]/20 bg-[#E0F2FE] p-8 sm:p-12 shadow-xs">
            <div className="mx-auto mb-4 flex size-12 items-center justify-center rounded-full bg-white text-[#0077CC] shadow-xs">
              <Sparkles size={22} />
            </div>
            <h2 className="text-2xl font-bold tracking-tight text-[#0F172A] sm:text-3xl mb-3">
              Evalúa el uso de IA con evidencia, no con sospecha
            </h2>
            <p className="mx-auto max-w-lg text-sm text-[#334155] sm:text-base mb-8">
              Crea tu primer curso en segundos e invita a tus estudiantes a entregar sus conversaciones de IA.
            </p>
            <Link
              to="/onboarding"
              className="inline-flex items-center gap-2 rounded-md bg-[#0077CC] px-6 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-[#0066B3] shadow-xs"
            >
              Comenzar ahora
              <ArrowRight size={16} />
            </Link>
